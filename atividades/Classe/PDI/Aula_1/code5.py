...
show_image(load_page_image(),'imagem original')

# mostrar Global thresholdind
...
show_image(binary_global, 'binary image global thresholding')
...
show_image(binary_local, 'binary image local thresholding')
